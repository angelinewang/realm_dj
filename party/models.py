...
class Party(models.Model):
    ...
    venue_id = models.ForeignKey(Venue, related_name ='venues', on_delete = models.PROTECT)
    ...
    vibe = models.CharField(choices=[x.value for x in VIBE], null=True, default=VIBE.get_value(VIBE.chill), max_length=50)

    def __str__(self):
        return f"{self.venue_id}: {self.first_entry}"
